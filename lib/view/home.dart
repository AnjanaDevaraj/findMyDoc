      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  SizedBox(height: 12,),
                  Image.network(
                    "https://cdn3.iconfinder.com/data/icons/solid-locations-icon-set/64/Dentist_2-128.png",
                    width: 30,
                    height: 30,),
                  SizedBox(height: 6,),
                  Text("Dental")
            ...
            SizedBox(height: 16,),
            Text("Top doctors near me",
              style: TextStyle(fontWeight: FontWeight.bold),),
            SizedBox(height: 12,),
            CarouselSlider(items: List.generate(2, (index) =>
                Container(
                  width: 200,
                 // height: 100,
                  decoration: ShapeDecoration(
